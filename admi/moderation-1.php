...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST["type"]) && !empty($_POST["reason"]) && !empty($_POST["username"])) {
        ...
        if (isset($typeToAction[$type])) {
            ...
            $userclass::moderate($username, $action, $reason, $actionToTime[$action]); // moderate the user specified with the type
        } else {
...
<div class="container">
    ...
    <a href="viewmoderation" class="btn btn-primary">View moderation actions</a>
