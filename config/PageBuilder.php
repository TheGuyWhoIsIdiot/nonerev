...
class PageBuilder
{
    ...
    [
        ...
        "og:url" => "http://n16.ct8.pl/",
        "og:description" => "An old roblox revival that goes for the win.",
        "og:image" => "http://n16.ct8.pl/img/nonelogo.png",
    ...
    <button class="btn btn-primary btn-lg btn-block">Upgrade Now</button>
            ...
            <?php if (isset($_SESSION["user"])) : ?>
                <?php if ($_SESSION["user"]["email"] == "") : ?>
                    ...
                    You are getting this alert because it seems you don't have a email attached to your account. Why not add one?
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        <?php
