...
$greetings = array(
    ...
    "Portuguese" => "Ola",
    "Arabic" => "مرحبًا",
    "Comedy" => "helo an welcum 2 litl timmie's chennel",
    "Car" => "*honk*",
    "Insult" => "fuck you",
...
<script type='text/javascript'>window.Sys || document.write("<script type='text/javascript' src='/js/Microsoft/MicrosoftAjax.js'><\/script>")</script>
    ...
    <script type='text/javascript' src='/896306f7ffcd1e8f0a52a947eee9d07e.js.gzip'></script>
...
<div id="HomeContainer" class="home-container"
    ...
    <h1>Hello, <span class="notranslate"><?= $_SESSION["user"]["username"] ?></span>!</h1>
...
<div id="UserAvatar" class="thumbnail-holder"  data-3d-thumbs-enabled data-url="/img/pending.png" style="width:210px; height:210px;">
    <span class="thumbnail-span" data-3d-url="/avatar-thumbnail-3d/json?userId=59896360"  data-js-files='/a552a24cb2c7a47ad748fd129a2e9624.js.gzip' ><img alt='samis2613' class='' src='http://t0.rbxcdn.com/247d766b361733eaf1ef07715db1758e' /></span>
...
<div id="RobloxNews">
    <div class="roblox-news-feed">
                <div class="roblox-news-feed-item">
                    <a href="http://blog.n16.ct8.pl/2014/11/experience-these-six-unbelievably-good-looking-games/" ref="news-article" class="roblox-interstitial">Experience These Six Unbelievably Good Looking Games</a>
                </div>
    ...
    <img alt="See more! "
        ...
        <div class="user">
            <a href="/User.aspx?ID=43928394"><span class="avatar-image-link" data-3d-url="/avatar-thumbnail-3d/json?userId=43928394"  data-js-files='/a552a24cb2c7a47ad748fd129a2e9624.js.gzip' ><img alt='zaidk5' class='' src='http://t3.rbxcdn.com/9b4e303fec2be2ab59ca8e4b27b13fb6' /></span></a>
            
            <div class="info">
                    <img alt="offline" src="http://images.rbxcdn.com/3a3aa21b169be06d20de7586e56e3739.png" title="Offline" />
                <a class="name" href="/User.aspx?ID=43928394">None</a>
            </div>
            <div class="clear"></div>
        </div>
...
<div class="text">
  ...
  $stmt->execute();
  $feedmessages = $stmt->fetchAll();
  
  foreach($feedmessages as $feed) {
    $query = "SELECT * FROM users WHERE id=:id";
    $stmt = $pdo->prepare($query);
    $stmt->bindParam(':id', $feed['id']);
    $stmt->execute();
    $account = $stmt->fetch();
    ...
    {
    $date = $feed['time'];
    $redirectLink = "/User.aspx?id=".$feed['id'];
      
    if ($feed['isGroup'] == 1)
    {
      $redirectLink = "/My/Groups.aspx?gid=".$feed['id'];
    }
      
    $year = substr($date, 0, 4);
    $otherdatestuff = str_replace(array("-", ":"), " ", $year);
    
    ?>
     <div class="divider-top feed-container">
        <div class="feed-image-container notranslate">
<a href="<?php echo $redirectLink ?>" class="feed-asset" ><img  class='feed-asset-image' src='http://t1.rbxcdn.com/2a6d419dbbf2f44112992c892e0f1f90' /></a>        </div>

        <div class="feed-text-container text">
            <span class="notranslate"><a href='/My/Groups.aspx?gid=1100313'><?php echo $account['username'] ?></a><br><div class='Feedtext'>"<?php echo htmlspecialchars($feed['message']) ?>"</div></span>
            <span style="display: block; padding-top: 5px; color: #AAA; font-size: 11px;"><?php echo $otherdatestuff[0]; echo $otherdatestuff[1];  ?>/<?php echo $otherdatestuff[2]; echo $otherdatestuff[3];  ?>/<?php echo $year ?> at 6:55 PM</span>
        </div>
            
                <div class="feed-report-abuse">
                    <a href="/abusereport/feed?id=91229020&amp;redirectUrl=%2Fhome">
...
<div id="RecentlyVisitedPlaces">
        <div class="recent-place-container" style="display: block;">
            <div class="recent-place-thumb">
                <a href="/PlaceItem.aspx?ID=192800" ><img  class='recent-place-thumb-img' src='http://t7.rbxcdn.com/570d3fb096b0a8f079602bc7f2e9b1bf' /></a>
            </div>
            <a class="recent-place-link" href="/PlaceItem.aspx?ID=192800">Test</a>
                <div class="recent-place-players-online text">4085 players online</div>
        </div>
</div>
...
<div id="ChatContainer" style="position:fixed; bottom:0; right:0; z-index:10020;">
    ...
    <script type="text/javascript" language="javascript">
        Party.CurrentUserID = <?= $_SESSION["user"]["id"] ?>;
        Party.CurrentUserName = "<?= $_SESSION["user"]["username"] ?>";
        Party.ActiveView = "";
...
/> <b>All</b><br />
    ...
    <script type="text/javascript">
        ...
        ChatBar.MyUserName = "<?= $_SESSION["user"]["username"] ?>";
